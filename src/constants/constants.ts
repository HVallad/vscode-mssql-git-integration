...
export const cmdRefreshLocalCache = "mssql.refreshLocalCache";
export const cmdClearLocalCache = "mssql.clearLocalCache";
export const cmdClearAllLocalCaches = "mssql.clearAllLocalCaches";
...
export const cmdOpenGitRepository = "mssql.openGitRepository";
